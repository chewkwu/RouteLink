            ...
            out.println("<body>");
             User user = (User)request.getSession().getAttribute("user");
                try {
                    ...
                    customer.setCustomerFirstName(request.getParameter("fname"));
                    customer.setCustomerLastName(request.getParameter("lname"));
                    ...
                    request.setAttribute("feed", "Customer added Successfully");
