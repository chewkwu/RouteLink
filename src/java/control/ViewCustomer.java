        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<body>");
             User user = (User)request.getSession().getAttribute("user");
                try {
                    Customer customer = new CustomerDAO().getCustomer(request.getParameter("phone"));
                    if(customer == null){
                        RequestDispatcher rd = getServletContext().getRequestDispatcher("/custfeed.jsp");
                        request.setAttribute("feed", "No such Customer");
                        rd.forward(request, response);
                    }else{
                        RequestDispatcher rd = getServletContext().getRequestDispatcher("/acust.jsp");
